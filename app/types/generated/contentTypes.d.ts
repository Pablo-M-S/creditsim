...
export interface ApiInstallmentInstallment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amortization: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dueDate: Schema.Attribute.Date & Schema.Attribute.Required;
    interest: Schema.Attribute.Decimal;
...
export interface ApiLoanLoan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amortizationSystem: Schema.Attribute.Enumeration<['PRICE', 'SAC']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer: Schema.Attribute.Relation<'oneToOne', 'api::customer.customer'>;
    interestRates: Schema.Attribute.Decimal & Schema.Attribute.Required;
    iofAmount: Schema.Attribute.Decimal;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::loan.loan'> &
      Schema.Attribute.Private;
    principal: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    termMonths: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
